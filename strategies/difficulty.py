...
MISTAKE_PROFILES: Dict[str, MistakeProfile] = {
    'very_easy': MistakeProfile('very_easy', 0.15, 0.10, 'always',   False, -1, 'random',         15, 0.12, 0.08, 0.2,  False),
    'easy':      MistakeProfile('easy',      0.10, 0.05, 'any_outs', False, -1, 'random',         10, 0.08, 0.05, 0.4,  False),
    'normal':    MistakeProfile('normal',    0.04, 0.02, 'sloppy',   True,  -1, 'texture',          6, 0.05, 0.03, 0.7,  False),
    'hard':      MistakeProfile('hard',      0.0,  0.0,  'correct',  True,  10, 'texture',          3, 0.03, 0.02, 0.95, False),
    'expert':    MistakeProfile('expert',    0.0,  0.0,  'correct',  True,   5, 'texture_image',    1, 0.01, 0.01, 1.0,  True),
    'perfect':   MistakeProfile('perfect',   0.0,  0.0,  'correct',  True,   3, 'texture_image',    0, 0.0,  0.0, 1.0,  True),
}
